    ...
    iperbot: {
      ...
      csl: {
        ...
        content: <>
          <article>
            <p>
              This campaign was one to which I contributed during my time at AbelsonTaylor.
      ...
      arcutis: {
        ...
        content: <>
          <article>
            <p>
              Arcutis's topical product, Zoryve, was a large campaign encompassing many different digital executions.
      ...
      neurocrine: {
        ...
        content: <>
          <article>
            <p>
              With Neurocrine I was involved with a variety of
              websites, Interactive Visual Aids (IVAs), email campaigns, and online banner advertisements. The largest of 
      ...
      cooper: {
        ...
        content: <>
          <article>
            <p>
              This is a project that I built independently during my time at AbelsonTaylor. Cooper Surgical needed a temporary page for a new surgical
